...
public class MarkovChainTest {
    ...
    @Test
    public void testAddBigramWithEmptyStrings() {
        MarkovChain mc = new MarkovChain();
    ...
    @Test
    public void testTrainWithEmptyIterator() {
        MarkovChain mc = new MarkovChain();

        mc.train(new ArrayList<String>().iterator());
    ...
    @Test
    public void testResetWithInvalidInput() {
        MarkovChain mc = new MarkovChain();
